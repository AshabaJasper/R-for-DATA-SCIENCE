...
#There are 5 atomic verctors in R:
#-Logical, Numeric, Interger, Complex and Character
...
vtr4=c(35L,58L, 146L) #we use L such that it treats as an interger value, not numeric

class(vtr4)

#vtr5=c(58.34L)# This wont work as it takes only intergers
